...
![Use Case Diagram](./diagram/use-case-diagram.png)
...
![Backend Overall Architecture](./diagram/backend-overall-architecture.png)
...
![User Management Sequence Diagram](./diagram/sequence/user-management-sequence.png){width=0.90\linewidth}
...
![Movie Information Sequence Diagram](./diagram/sequence/movie-information-sequence.png){width=0.90\linewidth}
...
![Review and Bookmark Sequence Diagram](./diagram/sequence/review-bookmark-sequence.png){width=0.90\linewidth}
...
![Onboarding and Recommendation Sequence Diagram](./diagram/sequence/onboarding-recommendation-sequence.png){width=0.90\linewidth}
...
![AI Recommendation Chat Sequence Diagram](./diagram/sequence/ai-recommendation-chat-sequence.png){width=0.90\linewidth}
...
![Character Chat Sequence Diagram](./diagram/sequence/character-chat-sequence.png){width=0.90\linewidth}
...
| POST | `/api/character-chat/conversations` | 선택한 캐릭터와의 대화 세션을 생성한다. | Required |
...
![Genre and People ERD](./diagram/genre-people-erd.png)
...
![Review and Bookmark ER Diagram](./diagram/review-bookmark-erd.png)
...
![Onboarding and Recommendation ERD](./diagram/onboarding-recommendation-erd.png)
...
![AI Recommendation Chat ERD](./diagram/ai-recommendation-chat-erd.png)
...
![Character Chat ERD](./diagram/character-chat-erd.png)
